@php
    ...
    $appLocalLanguage = $languages->where('code', config('app.locale'))->first();
@endphp
                        ...
                        <div class="cta-form">
                            <form class="cta__subscribe mt-2 no-submit-loader">
                                ...
                                <div class="subscribe-group d-flex gap-2 form-group">
                                    ...
                                    <button class="btn btn--base flex-shrink-0" type="submit"><i
                                ...
                                <div class="dropdown dropdown--lang">
                                    <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                        ...
                                        <img class="dropdown-toggle__flag"
                                            src="{{$appLocalLanguage->image_src}}"
                                            alt="image">
                                        <span class="dropdown-toggle__text">{{ ucfirst($appLocalLanguage->name) }}</span>
                                    </button>
                                    <div class="dropdown-menu dropdown--lang">
                                        @foreach ($languages as $item)
                                        <a class="dropdown-item" href="{{ route('lang', $item->code) }}">
                                            <img class="dropdown-item__flag" src="{{ @$item->image_src }}"
                                                alt="img">
                                            <span class="dropdown-item__text"> {{ ucfirst($item->name) }}</span>
                                        </a>
                                        @endforeach
                                    </div>
                                </div>
