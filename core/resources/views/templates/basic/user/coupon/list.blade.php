                            ...
                            <x-panel.ui.table.body>
                                @forelse($coupons as $coupon)
                                    <tr>
                                        ...
                                        <td>
                                            <span>
                                                <span class="text--success">
                                                    {{ showDateTime($coupon->start_from, gs('date_format', getParentUser()->id)) }}
                                                </span>
                                                -
                                                <span class="text--warning">
                                                    {{ showDateTime($coupon->end_at, gs('date_format', getParentUser()->id)) }}
                                                </span>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <x-panel.other.status_switch :status="$coupon->status" :action="route('user.coupon.status.change', $coupon->id)" title="coupon" />
                                        </td>
                                        <td>
                                            <x-panel.ui.btn.table_action module="coupon" :id="$coupon->id">
                                                <x-staff_permission_check permission="edit coupon">
                                                    <x-panel.ui.btn.edit tag="button" : :data-resource="$coupon" />
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="coupon_name" type="text" value="{{ old('coupon_name') }}" required />
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            <label>@lang('Coupon Code')</label>
                            <input class="form-control" name="coupon_code" type="text" value="{{ old('coupon_code') }}" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class=" input--group input-group">
                                <input class="form-control" name="minimum_amount" type="number" value="{{ old('minimum_amount') }}" required step="any">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="discount_type" required data-minimum-results-for-search="-1">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group input--group">
                                <input class="form-control" name="maximum_using_time" type="number" value="{{ old('maximum_using_time') }}" step="any" required>
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input class="form-control date-picker" name="start_from" type="text" value="{{ old('start_from') }}" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            <label>@lang('End At')</label>
                            <input class="form-control date-picker" name="end_at" type="text" value="{{ old('end_at') }}" autocomplete="off" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
