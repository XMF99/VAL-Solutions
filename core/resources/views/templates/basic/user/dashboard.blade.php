...
@section('panel')
            ...
            <div class="col-12">
                <div class="alert alert--danger d-flex" role="alert">
                    ...
                    <div class="alert__content">
                        <h5 class="mb-2 text--danger">@lang('KYC DOCUMENTS REJECTED')</h5>
                        <div class="mb-0">
                            {{ __(@$kyc->data_values->reject) }}
                            <div class="mt-1">
                                <a href="{{ route('user.kyc.form') }}">@lang('Click Here to Re-submit Documents'). | </a>
                                <a href="{{ route('user.kyc.data') }}">@lang('See Your KYC Data') |</a>
                                <button data-bs-toggle="modal" data-bs-target="#kycRejectionReason">@lang('Show Reason')
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        @elseif($user->kv == Status::KYC_UNVERIFIED)
            <div class="col-12">
                <div class="alert alert--warning d-flex" role="alert">
                    ...
                    <div class="alert__content">
                        <h5 class="mb-2 text--warning">@lang('KYC VERIFICATION REQUIRED')</h5>
                        <p>
        ...
        @elseif($user->kv == Status::KYC_PENDING)
            <div class="col-12">
                <div class="alert alert--info d-flex" role="alert">
                    ...
                    <div class="alert__content">
                        <h5 class="mb-2 text--warning">@lang('KYC VERIFICATION PENDING')</h5>
                        <p>
            ...
            <div class="row responsive-row mb-0">
                <x-staff_permission_check permission="view sale">
                    <div class="col-xxl-3 col-sm-6">
                        <x-panel.ui.widget.four url="{{ route('user.sale.list') }}?date={{ $today }}"
    ...
    @if ($user->kv == Status::KYC_UNVERIFIED && $user->kyc_rejection_reason)
        <x-panel.ui.modal id="kycRejectionReason">
            <x-panel.ui.modal.header>
                <h1 class="modal-title">@lang('KYC Document Rejection Reason')</h1>
