...
@push('style')
    <style>
        ...
        [data-theme="dark"] .invoice-pdt-table-wrapper {
        ...
        [data-theme="dark"] .invoice-pdt-table thead>tr>th,
        .invoice-pdt-table tbody>tr>td {
            border-bottom: 1px solid rgba(255, 255, 255, 0.1);
        }
        ...
        [data-theme="dark"] .totals-wrapper {
            border: 1px solid rgba(255, 255, 255, 0.1);
        }
        ...
        [data-theme="dark"] table.totals-table tr td {
