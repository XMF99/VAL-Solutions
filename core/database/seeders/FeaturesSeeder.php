...
class FeaturesSeeder extends Seeder
{
    public function run(): void
    {
        $features = [
            ...
            // نقطة البيع
            ['code' => 'pos', 'name_ar' => 'نقطة البيع', 'name_en' => 'Point of Sale', 'category' => 'pos', 'icon' => 'las la-cash-register', 'route_name' => 'user.pos.index'],
            ...
            ['code' => 'customer-credit', 'name_ar' => 'حسابات العملاء', 'name_en' => 'Customer Credit', 'category' => 'customers', 'icon' => 'las la-coins'],
            ...
            ['code' => 'low-stock-alerts', 'name_ar' => 'تنبيهات المخزون', 'name_en' => 'Low Stock Alerts', 'category' => 'inventory', 'icon' => 'las la-exclamation-triangle'],
            ['code' => 'expiry-tracking', 'name_ar' => 'تتبّع الانتهاء', 'name_en' => 'Expiry Tracking', 'category' => 'inventory', 'icon' => 'las la-calendar-times', 'is_premium' => true],
            // المشتريات
            ...
            ['code' => 'supplier-management', 'name_ar' => 'إدارة الموردين', 'name_en' => 'Suppliers', 'category' => 'purchases', 'icon' => 'las la-truck'],
            // المالية
            ...
            ['code' => 'zatca-integration', 'name_ar' => 'الفاتورة الإلكترونيّة', 'name_en' => 'ZATCA', 'category' => 'settings', 'icon' => 'las la-file-invoice-dollar', 'is_premium' => true],
            ['code' => 'multi-currency', 'name_ar' => 'عملات متعدّدة', 'name_en' => 'Multi Currency', 'category' => 'settings', 'icon' => 'las la-coins', 'is_premium' => true],
        ...
        $planMap = [1 => $basicFeatures, 2 => $advancedFeatures, 3 => $professionalFeatures, 4 => $enterpriseFeatures];
        ...
        $this->command->info('✅ تمّت إضافة ' . count($features) . ' ميزة وربطها بـ4 باقات');
    }
}