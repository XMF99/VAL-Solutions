...
trait SaleOperation
{
    ...
    public function pdf($id)
    {
        ...
        $pdf       = Pdf::loadView(activeTemplate() . 'user.sale.pdf', compact('sale', 'pageTitle'));
    ...
    public function store(Request $request)
    {
        ...
        if ($request->save_action_type == 'save_and_print') {
            $html = view($request->invoice_type == 'regular' ? '' . activeTemplate() . '.user.sale.invoice' : '' . activeTemplate() . '.user.sale.pos_invoice', compact('sale'))->render();
        }
