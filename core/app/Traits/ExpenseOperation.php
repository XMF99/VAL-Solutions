...
trait ExpenseOperation
{
    ...
    public function save(Request $request, $id = 0)
    {
        ...
        if (!$id) {
            ...
            createRegisterTransaction(Status::CASH_REGISTER_TYPE_EXPENSE, $request->amount, $details);
        } else {
            if ($oldExpenseAmount != $expense->amount) {
                ...
                if ($expense->amount > $oldExpenseAmount) {
                    ...
                    createRegisterTransaction(Status::CASH_REGISTER_TYPE_EXPENSE, $amount, $details);
                } else {
                    ...
                    createRegisterTransaction(Status::CASH_REGISTER_OTHER_CREDIT, $amount, $details);
                }
            }
        }
