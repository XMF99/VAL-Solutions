...
Route::middleware(['auth'])->name('user.')->group(function () {
    ...
    Route::middleware(['check.status', 'registration.complete', 'one.time.password'])->group(function () {
        ...
        Route::namespace('User')->group(function () {
            ...
            Route::middleware('kyc')->group(function () {
                ...
                Route::controller('ProductController')->name('product.')->prefix('product')->group(function () {
                    ...
                    Route::post('import', 'importProduct')->name('import')->middleware(['staff.permission:add product', 'has.subscription']);
