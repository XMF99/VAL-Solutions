...
Route::namespace('Api')->name('api.')->group(function () {
    ...
    Route::controller('AppController')->group(function () {
        ...
        Route::get('payment-gateways', 'paymentGateways');
    });
